...
<div class="main-header">
    ...
    <p>Tác giả: Hà Thị Hòa - Trường Tiểu học Minh Quang - ĐT: 0343342689</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hà Thị Hòa - Trường Tiểu học Minh Quang - ĐT: 0343342689</div>", unsafe_allow_html=True)
